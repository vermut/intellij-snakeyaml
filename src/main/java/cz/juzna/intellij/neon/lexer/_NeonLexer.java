/* The following code was generated by JFlex 1.4.3 on 15.19.5 15:15 */
 ...
 * on 15.19.5 15:15 from the specification file
...
public class _NeonLexer implements FlexLexer {
  ...
  private static final String ZZ_ACTION_PACKED_0 =
    ...
    "\1\6\1\3\1\7\1\10\1\2\1\11\1\2\1\12"+
    "\1\13\1\2\1\14\1\15\1\16\1\17\1\20\3\21"+
    "\1\22\1\23\3\24\1\25\1\24\1\26\1\27\1\30"+
    "\1\27\1\1\2\30\1\31\1\0\1\32\2\0\1\33"+
    "\1\0\1\33\1\0\1\34\2\35\1\36\1\0\1\36"+
    "\1\37\2\0\1\40\1\41\2\42\1\0\1\43\4\0"+
    "\1\44\1\0\1\45";
  ...
  private static final String ZZ_ROWMAP_PACKED_0 =
    ...
    "\0\214\0\u0188\0\214\0\214\0\u01a4\0\214\0\214\0\214"+
    "\0\u01c0\0\u01dc\0\214\0\u01f8\0\u0214\0\u0230\0\214\0\u024c"+
    "\0\214\0\u0268\0\u0284\0\u02a0\0\214\0\214\0\214\0\u02bc"+
    "\0\u02d8\0\u02f4\0\u02d8\0\214\0\250\0\214\0\340\0\u0310"+
    "\0\214\0\u032c\0\u0348\0\u016c\0\214\0\214\0\u0364\0\214"+
    "\0\u01a4\0\u0380\0\214\0\u01f8\0\u0214\0\214\0\214\0\u039c"+
    "\0\214\0\u024c\0\214\0\u0268\0\u03b8\0\u02bc\0\u03d4\0\u03f0"+
    "\0\u040c\0\214";
  ...
  private static final String ZZ_TRANS_PACKED_0 =
    ...
    "\1\14\1\15\1\16\1\17\1\20\1\6\2\15\1\6"+
    "\1\15\1\6\1\21\1\22\1\23\1\24\1\25\1\26"+
    "\1\27\1\30\1\15\1\6\1\7\1\10\1\11\1\6"+
    "\1\12\1\13\1\31\1\14\1\15\1\16\1\17\1\20"+
    "\1\6\2\15\1\6\1\15\1\6\1\21\1\22\1\23"+
    "\1\24\1\25\1\26\1\27\1\30\1\15\2\32\1\33"+
    "\5\32\1\34\2\32\1\35\2\32\2\33\1\32\1\33"+
    "\2\32\1\36\2\33\4\32\1\33\1\37\1\40\1\41"+
    "\1\42\1\37\1\41\2\37\1\43\1\41\1\44\1\41"+
    "\2\37\2\41\1\37\1\41\1\37\1\45\1\37\2\41"+
    "\1\37\4\41\2\46\1\47\5\46\1\50\3\46\3\51"+
    "\1\52\2\47\1\53\1\54\10\46\34\0\1\55\1\56"+
    "\1\0\31\55\10\0\1\10\23\0\2\57\1\0\1\56"+
    "\1\60\27\57\2\12\1\0\31\12\2\0\1\61\3\0"+
    "\1\62\1\0\1\61\6\0\1\63\3\61\21\0\1\14"+
    "\35\0\1\6\35\0\3\64\3\0\1\64\1\65\12\0"+
    "\1\66\5\0\1\66\2\0\1\66\3\0\1\67\3\66"+
    "\2\0\2\66\2\0\1\66\4\0\1\70\5\0\1\71"+
    "\6\0\1\72\3\70\11\0\2\31\1\0\31\31\2\32"+
    "\1\0\5\32\1\0\2\32\1\0\2\32\2\0\1\32"+
    "\1\0\2\32\3\0\4\32\1\0\2\73\1\0\2\73"+
    "\1\0\2\73\1\74\2\73\1\75\2\73\2\0\1\73"+
    "\1\0\2\73\3\0\4\73\14\0\1\76\22\0\1\77"+
    "\5\0\1\77\2\0\1\77\3\0\1\100\3\101\2\0"+
    "\2\77\2\0\1\77\2\0\1\102\1\103\1\0\31\102"+
    "\2\104\1\0\1\103\1\105\27\104\10\0\1\43\35\0"+
    "\1\37\31\0\1\106\3\0\1\107\33\0\3\51\3\0"+
    "\1\51\13\0\1\47\31\0\2\57\1\0\31\57\6\0"+
    "\1\110\27\0\1\61\33\0\1\66\33\0\1\70\33\0"+
    "\1\101\31\0\2\104\1\0\31\104\10\0\1\111\3\0"+
    "\3\107\3\0\1\107\1\112\10\0\2\110\1\0\31\110"+
    "\10\0\1\111\12\0\1\112\10\0";
  ...
  private static final String ZZ_ATTRIBUTE_PACKED_0 =
    "\4\0\1\1\1\11\6\1\1\11\1\1\1\11\1\1"+
    "\1\11\1\1\2\11\1\1\3\11\2\1\1\11\3\1"+
    "\1\11\1\1\1\11\3\1\3\11\4\1\1\11\1\0"+
    "\1\11\2\0\1\11\1\0\1\1\1\0\2\11\1\1"+
    "\1\11\1\0\1\1\1\11\2\0\2\11\1\1\1\11"+
    "\1\0\1\11\4\0\1\1\1\0\1\11";
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        case 34: 
          ...
          System.out.println("action [102] { a=305;retryInState(YYINITIAL); }");
          { a=305;retryInState(YYINITIAL);
          }
        case 38: break;
        case 36: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [54] { return NEON_HEADER; }");
          { return NEON_HEADER;
          }
        case 39: break;
        case 28: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [42] { a=2;retryInState(IN_ASSIGNMENT); }");
          { a=2;retryInState(IN_ASSIGNMENT);
          }
        case 40: break;
        case 20: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [126] { a=406;retryInState(YYINITIAL); }");
          { a=406;retryInState(YYINITIAL);
          }
        case 41: break;
        case 32: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [98] { a=3011; }");
          { a=3011;
          }
        case 42: break;
        case 5: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [75] { return NEON_COMMENT; }");
          { return NEON_COMMENT;
          }
        case 43: break;
        case 14: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [71] { return NEON_LBRACE_SQUARE; }");
        ...
        case 27: 
          ...
          zzMarkedPos = zzStartRead + 1;
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [58] { return NEON_ARRAY_BULLET; }");
          { return NEON_ARRAY_BULLET;
          }
        case 45: break;
        case 7: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [67] { return NEON_LBRACE_CURLY; }");
          { return NEON_LBRACE_CURLY;
          }
        case 46: break;
        case 19: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [121] { a=405;retryInState(IN_ASSIGNMENT_LITERAL);"+ZZ_NL+"        return NEON_LITERAL; }");
        ...
        case 15: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [50] { return NEON_TAG; }");
          { return NEON_TAG;
          }
        case 48: break;
        case 3: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [92] { return NEON_UNKNOWN; }");
          { return NEON_UNKNOWN;
          }
        case 49: break;
        case 33: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [101] { a=304;retryInState(YYINITIAL); }");
          { a=304;retryInState(YYINITIAL);
          }
        case 50: break;
        case 21: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [119] { a=403;return NEON_WHITESPACE; }");
          { a=403;return NEON_WHITESPACE;
          }
        case 51: break;
        case 9: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [73] { return NEON_ASSIGNMENT; }");
        ...
        case 29: 
          ...
          zzMarkedPos = zzStartRead + 1;
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [60] { return NEON_COLON; }");
          { return NEON_COLON;
          }
        case 53: break;
        case 2: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [83] { yybegin(IN_LITERAL);"+ZZ_NL+"        return NEON_LITERAL; }");
          { yybegin(IN_LITERAL);
        return NEON_LITERAL;
          }
        case 54: break;
        case 8: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [68] { return NEON_RBRACE_CURLY; }");
          { return NEON_RBRACE_CURLY;
          }
        case 55: break;
        case 35: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [117] { a=401;return NEON_STRING; }");
          { a=401;return NEON_STRING;
          }
        case 56: break;
        case 17: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [104] { a=307;retryInState(YYINITIAL); }");
          { a=307;retryInState(YYINITIAL);
          }
        case 57: break;
        case 31: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [100] { a=303; }");
          { a=303;
          }
        case 58: break;
        case 18: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [103] { a=306; }");
          { a=306;
          }
        case 59: break;
        case 6: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [88] { return NEON_WHITESPACE; }");
          { return NEON_WHITESPACE;
          }
        case 60: break;
        case 4: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [79] { return NEON_INDENT; }");
          { return NEON_INDENT;
          }
        case 61: break;
        case 10: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [72] { return NEON_RBRACE_SQUARE; }");
          { return NEON_RBRACE_SQUARE;
          }
        case 62: break;
        case 37: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [108] { a=501; retryInState(IN_ASSIGNMENT); }");
          { a=501; retryInState(IN_ASSIGNMENT);
          }
        case 63: break;
        case 23: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [113] { a=505; }");
          { a=505;
          }
        case 64: break;
        case 22: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [118] { a=402;return NEON_ASSIGNMENT; }");
          { a=402;return NEON_ASSIGNMENT;
          }
        case 65: break;
        case 25: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [109] { a=502; retryInState(IN_ASSIGNMENT); }");
          { a=502; retryInState(IN_ASSIGNMENT);
          }
        case 66: break;
        case 26: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [46] { return NEON_STRING; }");
          { return NEON_STRING;
          }
        case 67: break;
        case 11: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [62] { return NEON_ITEM_DELIMITER; }");
          { return NEON_ITEM_DELIMITER;
          }
        case 68: break;
        case 12: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [65] { return NEON_LPAREN; }");
          { return NEON_LPAREN;
          }
        case 69: break;
        case 13: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [66] { return NEON_RPAREN; }");
          { return NEON_RPAREN;
          }
        case 70: break;
        case 16: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [99] { a=302; }");
          { a=302;
          }
        case 71: break;
        case 30: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [63] { return NEON_LINE_CONTINUATION; }");
          { return NEON_LINE_CONTINUATION;
          }
        case 72: break;
        case 1: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [112] { a=504; }");
          { a=504;
          }
        case 73: break;
        case 24: 
          System.out.println("match: --"+yytext()+"--");
          System.out.println("action [110] { a=503;retryInState(IN_ASSIGNMENT); }");
